...
<!-- header -->
   <div class="agileits_header">
      ...
      <h1><a href="index.php"><span><font color="white">Grocery</font></span> Store</a></h1>
      </div>
   ...
   <div class="products-breadcrumb">
      <div class="container">
         <ul>
            ...
            <li style="margin-left:500px;"><a href="inedx1.php"><button style=" border-radius:15px;"><font color="red">ALL PRODUCTS</font></button></a></li>
